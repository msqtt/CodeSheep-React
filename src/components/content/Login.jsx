...
class Login extends Component {
  ...
  handleEmailChange = () => {
    ...
    if (email !== "" && !emailReg.test(email)) {
      if (!this.state.emailError) this.setState({ emailError: true });
    } else {
      ...
      <React.Fragment>
        ...
        <Card variant="outlined">
          ...
          >
            <Tooltip title="请输入正确的邮箱">
              <TextField
                ...
                sx={{ marginBottom: "0.5rem", width: "15.0rem" }}
              />
            </Tooltip>
            ...
            <FormControlLabel
              ...
              control={
                <Checkbox onChange={this.handleCheckBox} color="secondary" />
              }
            />
          ...
          >
            <Alert
              onClose={this.handleSnackClose}
              severity={this.state.snackBarStatus}
              sx={{ width: "100%" }}
            >
              {this.state.vaildMsg}
            </Alert>
